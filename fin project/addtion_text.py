...
from audio_steganography import embed_addition, decode_addition, compute_audio_snr
...
# ── Embed ─────────────────────────────────────────────────────────────────────
stego_audio = embed_addition(cover_audio, secret_text,
...
wavfile.write("stego_output_addtion.wav", sample_rate,
              (stego_audio * 32768).astype(np.int16))
print("Stego audio saved to stego_output_addtion.wav")

# ── Decode ────────────────────────────────────────────────────────────────────
_, stego_loaded = wavfile.read("stego_output_addtion.wav")
...
snr = compute_audio_snr(cover_audio, stego_audio)
